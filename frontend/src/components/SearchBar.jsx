...
const SearchBar = ({ onSearch }) => {
  ...
  return (
    <div className="flex justify-center mt-6">
      ...
      <div className="flex items-center border border-gray-700 rounded-full shadow-md p-2 w-96 bg-gray-800">
        {/* Input Field */}
        <input
          type="text"
          value={query}
          ...
          className="outline-none w-full px-3 text-gray-300 text-lg bg-gray-800"
        />
